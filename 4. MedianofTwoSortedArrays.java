class Solution {
    public double findMedianSortedArrays(int[] smaller, int[] larger) {
        ...
        if (smaller.length > larger.length) 
            return findMedianSortedArrays(larger, smaller);
        ...
        while (low <= high) {
            ...
            int mid2 = (sn + ln + 1) / 2 - mid1;

           
            int l1 = (mid1 == 0) ? Integer.MIN_VALUE : smaller[mid1 - 1];
            int l2 = (mid2 == 0) ? Integer.MIN_VALUE : larger[mid2 - 1];
